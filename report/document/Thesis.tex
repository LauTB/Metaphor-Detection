...
\author{\\\vspace{0.25cm}Laura Tamayo Blanco}
\advisor{\\\vspace{0.25cm}MSc. Damian Valdés Santiago}
\degree{Licenciado en Ciencia de la Computación}
\faculty{Facultad de Matemática y Computación}
\date{\today \\\vspace{0.25cm}\href{https://github.com/LauTB/Metaphor-Detection}{https://github.com/LauTB/Metaphor-Detection}}
